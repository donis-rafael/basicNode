...
const IndSemClienteXFrente = db.define("IndSemClienteXFrente", {
    id_Cliente: {
        type: DataTypes.UUID
    },
    Frente: {
    ...
    tableName: 'IndSemClienteXFrente'
});

IndSemClienteXFrente.removeAttribute('id');

module.exports = IndSemClienteXFrente;