...
const IndDiariosClienteXFrente = db.define("IndDiariosClienteXFrente", {
    id_Cliente: {
        type: DataTypes.UUID
    },
    Frente: {
    ...
    tableName: 'IndDiariosClienteXFrente'
});

IndDiariosClienteXFrente.removeAttribute('id');

module.exports = IndDiariosClienteXFrente;